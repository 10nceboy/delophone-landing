import{g as w,f as o,h as g}from"./menu-91078bf9.js";const C=e=>{localStorage.setItem("cartArray",JSON.stringify(e))},h=()=>JSON.parse(localStorage.getItem("cartArray"))||[],E={mobile:"Мобильные",499:"Москва (499)",495:"Москва (495)",49599:"Москва 499+495 (комплект)",8800:"8 800",sochi:"Сочи",spb:"Санкт-Петербург",kras:"Краснодар"},q=[{id:"1",type:"single",group:"499",code1:"8 495",code2:"",number:"2434561",price:"990 ₽ разово",abonprice:"190 ₽/мес"},{id:"2",type:"pair",group:"49599",code1:"8 495",code2:"8 499",number:"2564561",price:"1 990 ₽ разово",abonprice:""},{id:"3",type:"vip",group:"495",code1:"8 495",code2:"",number:"7277777",price:"450 000 ₽",abonprice:""},{id:"4",type:"vip",group:"sochi",code1:"8 495",code2:"",number:"7777777",price:"450 000 ₽",abonprice:""},{id:"5",type:"pair",group:"49599",code1:"8 495",code2:"8 499",number:"7377777",price:"150 000 ₽",abonprice:""},{id:"6",type:"single",group:"mobile",code1:"8 988",code2:"",number:"2934566",price:"990 ₽ разово",abonprice:"190 ₽/мес"},{id:"7",type:"single",group:"kras",code1:"8 861",code2:"",number:"2434567",price:"990 ₽ разово",abonprice:"190 ₽/мес"},{id:"8",type:"single",group:"495",code1:"8 495",code2:"",number:"2434568",price:"990 ₽ разово",abonprice:"190 ₽/мес"},{id:"9",type:"single",group:"495",code1:"8 495",code2:"",number:"4434569",price:"990 ₽ разово",abonprice:"190 ₽/мес"},{id:"10",type:"single",group:"8800",code1:"8 800",code2:"",number:"1233567",price:"990 ₽ разово",abonprice:"190 ₽/мес"}],d=document.querySelector(".cart__content-upside"),p=document.querySelector(".choose__phones-cards"),A=document.querySelector(".cart__summary"),l=document.querySelector(".cart__button-buy"),$=document.querySelector(".cart__header"),a=document.querySelector(".cart__mobile-quantity");let r=[];const f=()=>`
  ...
  >
    ...
    <path
      ...
      fill="#9CA5AC"
    />
  </svg>`,m={single:"single",pair:"pair",vip:"vip"},I=()=>{q.forEach(e=>{switch(e.type){case m.single:p.innerHTML+=`<div class="card card_white choose__phones-card" data-id="${e.id}">
      <div class="choose__phones-single-number no-select">
    ...
    </div> `;break;case m.pair:p.innerHTML+=`
        ...
        `;break;case m.vip:p.innerHTML+=`<div class="card card_white choose__phones-card" data-id ="${e.id}" >
        ...
        </div>`;break}})},T=e=>{if(r.some(t=>t.id===e))return!1;{const t=q.find(s=>s.id===e);return r.push(t),t}},S=e=>{const t=r.findIndex(c=>c.id===e);if(t<0)return;const s=d.querySelectorAll(".cart__item")[t];s.classList.add("cart__item_deleted"),r.splice(t,1),s.addEventListener("animationend",()=>{b(),C(r)},{once:!0})},k=e=>`<div class="cart__content-header no-select">${E[e]??""}</div>`;function L(e){var c,i,n;const{target:t}=e,s=(i=(c=t.parentElement)==null?void 0:c.parentElement)==null?void 0:i.dataset.cartItemId;(n=document.querySelector(`.choose__phones-card_disabled[data-id="${s}"]`))==null||n.classList.remove("choose__phones-card_disabled"),s&&S(s)}const b=()=>{r=w(r,"group");let e=null,t="";r.length==0&&(location.pathname.includes("order")?t=` <div class="cart__content-header">
...
покупки.
</div>`);let s=d.querySelectorAll(".cart__item-icon");s.forEach(c=>c.removeEventListener("click",L)),r.forEach(({id:c,number:i,code1:n,code2:_,group:u,abonprice:v,price:y,type:x})=>{e!==u&&(e=u,t+=k(u)),x!=="pair"?t+=`<div class="card card_white cart__item" data-cart-item-id=${c}>
 ...
 <div class="cart__item-price no-select">${y}<div class="cart__item-price_per-month no-select">${v}</div>
      ...
      <div class="cart__item-pair-numbers no-select">
        ...
        <div class="cart__item-number">
        <span class="choose__city-code">${_}</span> ${i.substring(0,3)}-${i.substring(3,5)}-${i.substring(5,7)}
        </div>
      </div>
      <div class="cart__item-price no-select">${y}</div>
      <div class="cart__item-price_per-month no-select">${v}</div>
      ${f()}
      </div>`}),d.innerHTML=t,s=d.querySelectorAll(".cart__item-icon"),s.forEach(c=>{c.addEventListener("click",L)}),M(),H()},H=()=>{let e=0,t=0;r.forEach(c=>{e+=parseInt(c.price.split(" ").join(""),10),t+=parseInt(c.abonprice.split(" ").join(""),10)||0}),A.innerHTML=`
  <div class="cart__summary">
    <span class="cart__summary_once">${o(e)} ₽,</span>
    <span class="cart__summary_per-month"> ${o(t)} ₽/мес </span>
  </div>`;const s=document.querySelector(".order__pay-once");if(s){const c=document.querySelector(".order__pay-per-month"),i=document.querySelector(".order__summary");s.textContent=o(e),c.textContent=o(t),i.textContent=o(t+e),document.querySelector(".order__summary-button").textContent=document.querySelector(".order__summary").textContent}},M=()=>{var t,s;let e=r.length;$.innerHTML=`
...
`,$.classList.add("no-select"),(a||l)&&(e==0?(l.disabled=!0,a.classList.remove("cart__mobile-quantity_active"),(t=document.querySelector(".cart__mobile-button"))==null||t.classList.remove("cart__mobile-button_active")):e==1&&(l.textContent="Купите номер телефона"),e>0?(l.disabled=!1,a.classList.add("cart__mobile-quantity_active"),a.textContent=e,(s=document.querySelector(".cart__mobile-button"))==null||s.classList.add("cart__mobile-button_active")):a.classList.remove("cart__mobile-quantity_active"))},P=()=>{location.pathname.includes("order")?r=h():(r=h(),I(),document.querySelectorAll(".choose__phones-card").forEach(t=>{const s=t.dataset.id;r.some(c=>c.id===s)&&t.classList.add("choose__phones-card_disabled"),t.addEventListener("click",()=>{if(!T(s)){t.classList.remove("choose__phones-card_disabled"),S(s),r.length!==0?a.textContent=r.length:a.classList.remove("cart__mobile-quantity_active");return}t.classList.add("choose__phones-card_disabled"),b();const i=r.findIndex(_=>_.id===s);d.querySelectorAll(".cart__item")[i].classList.add("cart__item_new"),C(r)})})),b()};P();
