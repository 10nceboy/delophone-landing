import{g as C,h as y}from"./menu-d5da2a40.js";const m=e=>{localStorage.setItem("cartArray",JSON.stringify(e))},q=()=>JSON.parse(localStorage.getItem("cartArray"))||[],S={mobile:"Мобильные",499:"Москва (499)",495:"Москва (495)",49599:"Москва 499+495 (комплект)",sochi:"Сочи",spb:"Санкт-Петербург",kras:"Краснодар"},f=[{id:"1",type:"single",group:"499",code1:"8 495",code2:"",number:"2434561",price:"990₽ разово",abonprice:"190 ₽/мес"},{id:"2",type:"pair",group:"49599",code1:"8 495",code2:"8 499",number:"2564561",price:"1 990₽ разово",abonprice:""},{id:"3",type:"vip",group:"495",code1:"8 495",code2:"",number:"7277777",price:"450 000 ₽",abonprice:""},{id:"4",type:"vip",group:"sochi",code1:"8 495",code2:"",number:"7777777",price:"450 000 ₽",abonprice:""},{id:"5",type:"pair",group:"49599",code1:"8 495",code2:"8 499",number:"7377777",price:"150 000 ₽",abonprice:""},{id:"6",type:"single",group:"mobile",code1:"8 495",code2:"",number:"2934566",price:"990₽ разово",abonprice:"190 ₽/мес"},{id:"7",type:"single",group:"kras",code1:"8 861",code2:"",number:"2434567",price:"990₽ разово",abonprice:"190 ₽/мес"},{id:"8",type:"single",group:"499",code1:"8 495",code2:"",number:"2434568",price:"990₽ разово",abonprice:"190 ₽/мес"},{id:"9",type:"single",group:"499",code1:"8 495",code2:"",number:"2434569",price:"990₽ разово",abonprice:"190 ₽/мес"}],o=document.querySelector(".cart__content-upside"),u=document.querySelector(".choose__phones-cards"),w=document.querySelector(".cart__summary"),d=document.querySelector(".cart__button-buy"),E=document.querySelector(".cart__header"),n=document.querySelector(".cart__mobile-quantity");let r=[];const $=()=>`
  ...
  >
    ...
    <path
      ...
      fill="#9CA5AC"
    />
  </svg>`,p={single:"single",pair:"pair",vip:"vip"},x=()=>{f.forEach(e=>{switch(e.type){case p.single:u.innerHTML+=`<div class="card card_white choose__phones-card" data-id="${e.id}">
      <div class="choose__phones-single-number no-select">
        ...
        </div>`;break}})},A=e=>{if(r.some(t=>t.id===e))return!1;{const t=f.find(s=>s.id===e);return r.push(t),t}},I=e=>{const t=r.findIndex(i=>i.id===e);if(t<0)return;const s=o.querySelectorAll(".cart__item")[t];s.classList.add("cart__item_deleted"),s.addEventListener("animationend",()=>{r.splice(t,1),b(),m(r)},{once:!0})},T=e=>`<div class="cart__content-header"">${S[e]??""}</div>`;function h(e){var i,c,a;const{target:t}=e,s=(c=(i=t.parentElement)==null?void 0:i.parentElement)==null?void 0:c.dataset.cartItemId;(a=document.querySelector(`.choose__phones-card_disabled[data-id="${s}"]`))==null||a.classList.remove("choose__phones-card_disabled"),s&&I(s)}const b=()=>{r=C(r,"group");let e=null,t="";r.length==0&&(t=` <div class="cart__content-header">
Нажимайте на подходящие номера, чтобы выбрать их для
покупки.
</div>`);let s=o.querySelectorAll(".cart__item-icon");s.forEach(i=>i.removeEventListener("click",h)),r.forEach(({id:i,number:c,code1:a,code2:l,group:_,abonprice:v,price:g,type:L})=>{e!==_&&(e=_,t+=T(_)),L!=="pair"?t+=`<div class="card card_white cart__item" data-cart-item-id=${i}>
          <div class="cart__item-number">
          <span class="choose__city-code">${a}</span> ${c.substring(0,3)}-${c.substring(3,5)}-${c.substring(5,7)}
 </div>
 <div class="cart__item-price">${g}<div class="cart__item-price_per-month">${v}</div>
      ...
      <div class="cart__item-price">${g}</div>
      <div class="cart__item-price_per-month">${v}</div>
      ${$()}
      </div>`}),o.innerHTML=t,s=o.querySelectorAll(".cart__item-icon"),s.forEach(i=>{i.addEventListener("click",h)}),H(),k()},k=()=>{let e=0,t=0;r.forEach(s=>{e+=parseInt(s.price.split(" ").join(""),10),t+=parseInt(s.abonprice.split(" ").join(""),10)||0}),w.innerHTML=`
  <div class="cart__summary">
    <span class="cart__summary_once">${e} ₽,</span>
    <span class="cart__summary_per-month"> ${t} ₽/мес </span>
  </div>`},H=()=>{var t,s;let e=r.length;E.innerHTML=`
